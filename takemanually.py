...
def manually_fill():
    ...
    # Error screen for empty subject name
    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            # Error screen for empty enrollment or student name
            def del_errsc2():
                errsc2.destroy()
            ...
            # Validation for Enrollment input
            ...
            # Function to clear enrollment entry
            def remove_enr():
            ...
            # Function to clear student name entry
            def remove_student():
                STUDENT_ENTRY.delete(first=0, last=22)

            # Enter data into dictionary and save to CSV
            def enter_data_DB():
                global index
                global d
            ...
            # Clear enrollment and student fields
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:/Users/patel/OneDrive/Documents/E/FBAS/Attendance(Manually)"')
